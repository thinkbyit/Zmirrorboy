...
Examples:
1. <code>{escape('<b>Join: @thinkbyit</b>')}</code> 
This will give output as:
<b>Join: @thinkbyit</b>  <code>69MB.bin</code>.

2. <code>{escape('<code>Join: @thinkbyit</code>')}</code> 
This will give output as:
<code>Join: @thinkbyit</code> <code>69MB.bin</code>.
